...
2. **パーマリンク生成**: 「Generate Permalink」ボタンで現在の地図ビューのリンクを生成
3. **コピー**: 「Copy」ボタンでクリップボードにコピー
4. **ブラウザで開く**: 「Open」ボタンでブラウザでリンクを確認
5. **ナビゲーション**: 他のパーマリンクを入力して地図を移動
...
- **現在バージョン**: V1.2.18（パネル形式・完全翻訳対応・自動タブ化機能）
